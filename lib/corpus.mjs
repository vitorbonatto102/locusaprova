...
export function confusionToTrainingItem(pair) {
  return {
    ...
    kind: "not_confuse",
    prompt: pair.scenario ?? pair.decisive_fact,
    question: `Analise as duas situações. Em cada uma, indique a tese, o fato que a sustenta, o fundamento e a consequência.`,
